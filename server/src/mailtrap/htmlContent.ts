            ...
            <body>
              <div class="email-container">
                ...
                <div class="email-body">
                  ...
                  <p>We are excited to have you on board at Foodie App. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The Foodie App Team</p>
                </div>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The Foodie App Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; ${new Date().getFullYear()} Foodie App. All rights reserved.</p>
            </div>
